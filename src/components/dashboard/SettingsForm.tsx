          ...
          <div className="grid gap-5 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              <SingleImageUploader
                ...
                aspect="aspect-[1640/620]"
                hint="MP4 أو WebM حتى 100MB، أو رابط مباشر لملف فيديو. يعمل صامتاً ومتكرراً فوق الصورة — احذفه للرجوع إلى الصورة الثابتة. ملاحظة: رابط فيديو Google Drive لا يصلح خلفية متحركة (يُعرض بمشغّل)، استخدمه في المعرض بدلاً من ذلك."
              />
            </div>
          </div>
